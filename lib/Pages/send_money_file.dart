...
class SendMoneyFile extends StatefulWidget {
  ...
  const SendMoneyFile({Key key, this.userId, this.username}) : super(key: key);
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      } else if (double.parse(amountController.text.replaceAll(',', '')) > Globals.walletbalance) {
                        CommonUtils.errorToast(context, "Insufficient balance in wallet");
  ...
  void _callApiForPay(String privacy) async {
    if (Globals.isOnline) {
      ...
      try {
        ...
        CommonModel result =
            await _payApi.search(amountController.text.replaceAll(',', ''), privacy, descriptionController.text, widget.userId.toString(), username, 'pay');
        print(result);
